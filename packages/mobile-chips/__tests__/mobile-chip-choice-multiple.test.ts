...
test.describe('Chip Choice Multi', () => {
  test.use({ viewport: { width: 390, height: 844 } });

  test('long list: opening multi chip shows many options; last option can be scrolled into view', async ({
    gotoStory,
    page,
  }) => {
    await gotoStory({
