...
import { MobileChipChoice, MobileChipChoiceCustomProps } from '../src';
...
const meta: Meta = {
  ...
  component: MobileChipChoice.Custom,
};
export default meta;

type StoryProps = MobileChipChoiceCustomProps & ChipChoiceCustomStoryProps;

const Template: StoryFn<StoryProps> = ({ ...args }: StoryProps) => {
  const [selectedValue, setSelectedValue] = useState<string>();

  return (
    <MobileChipChoice.Custom
      {...args}
      value={selectedValue}
