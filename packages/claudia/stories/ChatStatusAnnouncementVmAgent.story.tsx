...
const meta: Meta = {
  title: 'Console/Claudia/Chat Status Announcement/Chat Status Announcement VmAgent',
  component: ChatStatusAnnouncementVmAgent,
};
export default meta;

type StoryProps = ChatStatusAnnouncementVmAgentProps;

const Template = ({ ...props }: StoryProps) => (
  <div>
    <div className={cn(styles.wrapper, styles.chatStatusAnnouncementWrapper)}>
      <ChatStatusAnnouncementVmAgent {...props} />

      <ChatStatusAnnouncementVmAgent {...props} vmName={'my-lovely-vm-looooooooooooooooooooooooooooong'} />
    </div>
  </div>
);

export const chatStatusAnnouncementVmAgent: StoryObj<StoryProps> = {
  render: Template,
  args: {
