...
const Step = forwardRef<HTMLDivElement, StepProps>(
  ({ step, className, 'data-test-id': testId, hideTailLine, ...props }, ref) => (
    <div className={cn(styles.step, className)} data-state={step.state} {...extractSupportProps(props)} ref={ref}>
