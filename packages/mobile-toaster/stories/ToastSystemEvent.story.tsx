...
import { mobileToaster, MobileToastSystemEventProps } from '../src';
import { MobileToastSystemEvent } from '../src/components';
import { TOAST_SYSTEM_EVENT_APPEARANCE } from '../src/components/MobileToastSystemEvent/constants';
import styles from './styles.module.scss';

const meta: Meta = {
  title: 'Mobile/Toaster/Toast SystemEvent',
  component: MobileToastSystemEvent,
};
export default meta;
...
type StoryProps = MobileToastSystemEventProps & { showAction: boolean };
    ...
    <>
      <div className={styles.wrapper}>
        <ButtonFilled
          ...
          onClick={() =>
            mobileToaster.systemEvent[appearance]({
        ...
        <ButtonFilled
          ...
          data-test-id='toast-trigger'
          onClick={() => mobileToaster.systemEvent.dismiss()}
        />
      </div>
