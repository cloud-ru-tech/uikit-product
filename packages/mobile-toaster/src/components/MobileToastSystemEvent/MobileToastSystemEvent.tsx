...
export type MobileToastSystemEventLink = {
  text: string;
  href: string;
  onClick?(e: MouseEvent<HTMLAnchorElement>): void;
};

export type MobileToastSystemEventProps = Partial<RtToastContentProps> &
  WithSupportProps<{
    title: string;
    description?: string;
    appearance?: ToastSystemEventAppearance;
    link?: MobileToastSystemEventLink;
    progressBar?: boolean;
    closable?: boolean;
    className?: string;
...
export function MobileToastSystemEvent({
  appearance = 'neutral',
  onCloseClick,
  progressBar = true,
  closable = true,
