...
const Template: Story<ToggleCardDisplayProps> = args => {
...
export const toggleCardDisplay = Template.bind({});
toggleCardDisplay.args = { title: 'Title' };
toggleCardDisplay.argTypes = {};
toggleCardDisplay.parameters = {
  readme: {
