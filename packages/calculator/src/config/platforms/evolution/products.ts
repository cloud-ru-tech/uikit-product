...
export const EVOLUTION_PRODUCTS: CatalogConfig['products'] = {
  ...
  [EVOLUTION_PRODUCT.EvolutionManagedMetastore]: {
    id: EVOLUTION_PRODUCT.EvolutionManagedMetastore,
    platform: PLATFORM.Evolution,
    label: 'Evolution Managed Metastore',
    caption: 'Хранение метаданных с Metastore',
    formConfig: EVOLUTION_MANAGED_METASTORE_CONFIG,
    icon: MetastoreSVG,
    dataTestId: 'evolutionManagedMetastore',
    enableConnectToConsole: true,
  },
