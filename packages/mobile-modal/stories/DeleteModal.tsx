...
import { DefaultDeleteModalBody } from '@sbercloud/uikit-product-modal-predefined';
import { ButtonFilled } from '@snack-uikit/button';

import componentChangelog from '../CHANGELOG.md';
import componentPackage from '../package.json';
import componentReadme from '../README.md';
import { MobileDeleteModal, MobileDeleteModalProps } from '../src';
import styles from './styles.module.scss';

const meta: Meta = {
  title: 'Mobile/Modal/Delete Modal',
  component: MobileDeleteModal,
};

type StoryProps = MobileDeleteModalProps & {
...
export const deleteModal: StoryFn<StoryProps> = Template.bind({});
