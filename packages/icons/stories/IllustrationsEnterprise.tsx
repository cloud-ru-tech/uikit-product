...
import * as Icons from '../src/components/illustrations-enterprise-icons';
import { getTemplate } from './helpers/StoryTemplate';

const meta: Meta = {
  title: 'Snack Uikit/Icons/Illustrations/Enterprise',
};
export default meta;

const Template = getTemplate(Icons);

export const enterprise: StoryObj = Template.bind({});
