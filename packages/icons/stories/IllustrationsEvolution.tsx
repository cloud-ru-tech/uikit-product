...
import * as Icons from '../src/components/illustrations-evolution-icons';
import { getTemplate } from './helpers/StoryTemplate';

const meta: Meta = {
  title: 'Snack Uikit/Icons/Illustrations/Evolution',
};
export default meta;

const Template = getTemplate(Icons);

export const evolution: StoryObj = Template.bind({});
