...
1. Добавить скрипт генерации компонентов, на подобии существующих. Данный скрипт также должен вызываться из скрипта `compile`
2. Добавить реэкспорт в файле `src/index.ts` из сгенеренной папки
