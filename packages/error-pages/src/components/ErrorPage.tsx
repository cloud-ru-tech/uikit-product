  ...
  return (
    <div className={cn(styles.wrapper, className)} {...extractSupportProps(rest)}>
      ...
      <div className={styles.rightSide}>
        <svg className={styles.pic} viewBox='0 0 863 520' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <path
            ...
            stroke={`var(${COLORS.svgStroke})`}
            strokeWidth='2'
            strokeMiterlimit='10'
          />
          <path d='M735.999 165H81.7061' stroke={`var(${COLORS.svgStroke})`} strokeWidth='2' strokeMiterlimit='10' />
          <path
          ...
          />
          <path
            d='M148.586 311.289L124.086 283.727'
            stroke={`var(${COLORS.svgStroke})`}
            strokeWidth='2'
            strokeLinecap='round'
          />
          <path
            d='M159.336 300.565L130.242 279.127'
            stroke={`var(${COLORS.svgStroke})`}
            strokeWidth='2'
            strokeLinecap='round'
          />
          <path
            d='M166.969 286.789L133.281 273.008'
            stroke={`var(${COLORS.svgStroke})`}
            strokeWidth='2'
            strokeLinecap='round'
          />
          ...
          <path
            ...
            fill={`var(${COLORS.svgExclamationMark})`}
          />
          <path
