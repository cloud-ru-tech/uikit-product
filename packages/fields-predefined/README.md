...
|------|------|---------------|-------------|
| __@iterator@733* | `() => IterableIterator<string>` | - | Iterator |
...
| includedCountries | `({ readonly value: "russia"; readonly mask: "XXX XXX-XX-XX"; readonly caption: "+7"; readonly beforeContent: Element; readonly enabled: true; } \| { readonly value: "abkhazia"; readonly caption: "+7"; readonly mask: "XXX XXX-XX-XX"; readonly beforeContent: Element; readonly enabled: true; } \| ... 156 more ... \| { ......` | - | Список стран, которые должны отображаться в селекторе (будут выбраны из перечня стран, объявленных внутри пакета) |
| excludedCountries | `({ readonly value: "russia"; readonly mask: "XXX XXX-XX-XX"; readonly caption: "+7"; readonly beforeContent: Element; readonly enabled: true; } \| { readonly value: "abkhazia"; readonly caption: "+7"; readonly mask: "XXX XXX-XX-XX"; readonly beforeContent: Element; readonly enabled: true; } \| ... 156 more ... \| { ......` | - | Список стран, которые будут исключены из списка объявленных стран внутри пакета |
## SelectCreate
### Props
| name | type | default value | description |
|------|------|---------------|-------------|
