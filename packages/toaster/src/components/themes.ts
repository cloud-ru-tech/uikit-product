...
export const COLORS = {
  container: {
    background: {
      info: '--color-toaster__container__background__info',
      alarm: '--color-toaster__container__background__alarm',
    },
    border: {
      info: '--color-toaster__container__border__info',
      alarm: '--color-toaster__container__border__alarm',
    },
  },
  icon: {
    info: {
      fill: '--color-toaster__icon__info__fill',
      background: '--color-toaster__icon__info__background',
    },
    success: {
      fill: '--color-toaster__icon__success__fill',
      background: '--color-toaster__icon__success__background',
    },
    warning: {
      fill: '--color-toaster__icon__warning__fill',
      background: '--color-toaster__icon__warning__background',
    },
    warningCritical: {
      fill: '--color-toaster__icon__warning-critical__fill',
      background: '--color-toaster__icon__warning-critical__background',
    },
    warningAlarm: {
      fill: '--color-toaster__icon__warning-alarm__fill',
      background: '--color-toaster__icon__warning-alarm__background',
    },
    error: {
      fill: '--color-toaster__icon__error__fill',
      background: '--color-toaster__icon__error__background',
    },
    errorAlarm: {
      fill: '--color-toaster__icon__error-alarm__fill',
      background: '--color-toaster__icon__error-alarm__background',
    },
  },
  action: {
    info: {
      default: '--color-toaster__action__info__default',
      hover: '--color-toaster__action__info__hover',
    },
    alarm: {
      default: '--color-toaster__action__alarm__default',
      hover: '--color-toaster__action__alarm__hover',
    },
  },
  title: {
    info: '--color-toaster__title__info',
    alarm: '--color-toaster__title__alarm',
  },
  description: '--color-toaster__description',
};
