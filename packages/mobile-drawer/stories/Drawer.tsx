...
import { MobileDrawer } from '../src';
import { ARG_TYPES, CONTROLLED_DRAWER_ID, DEFAULT_ARGS, IMAGE_DRAWER_ID, IMAGE_PROP } from './constants';
import styles from './styles.module.scss';
import { DrawerStoryProps } from './types';

const meta: Meta = {
  title: 'Mobile/Drawer/Drawer',
  ...
  return (
    <>
      ...
      <MobileDrawer
        ...
        additionalButton={!args.additionalButton ? undefined : args.additionalButton}
      />
