...
import { DROPLIST_MAX_HEIGHT } from '../../../Floating/constants';
import { ADDITIONAL_BUTTON_SIZE, INFO_BOX_SIZE } from '../../constants';
...
export const scrollShrinkedClassName = css`
  max-height: ${DROPLIST_MAX_HEIGHT - ADDITIONAL_BUTTON_SIZE}px;
`;
