...
import { MobileInfoGroup, MobileInfoGroupItem, MobileInfoGroupProps } from '../src';

const meta: Meta = {
  title: 'Mobile/Info Row/Info Group',
  component: MobileInfoGroup,
};
export default meta;
...
type StoryProps = MobileInfoGroupProps<MockData>;

function Template({ items, data, ...args }: StoryProps) {
  return <MobileInfoGroup data={data} items={items} {...args} />;
}

export const infoGroup: StoryFn<StoryProps> = Template.bind({});
...
const items: MobileInfoGroupItem<MockData>[] = [
  {
    label: 'Имя',
