...
import { MobileAccordionSecondary, MobileCollapseBlockSecondaryProps } from '../src';
...
const meta: Meta = {
  title: 'Mobile/Accordion/CollapseBlockSecondary',
  component: MobileAccordionSecondary.CollapseBlock,
};

export default meta;

type StoryProps = MobileCollapseBlockSecondaryProps & {
  showTip: boolean;
  showActions: boolean;
  expanded: boolean;
...
const Template: StoryFn<StoryProps> = ({ id, showActions, customHeader, ...args }: StoryProps) => {
  ...
  return (
    <div className={styles.wrapper}>
      <MobileAccordionSecondary expanded={expanded} onExpandedChange={setExpanded}>
        <MobileAccordionSecondary.CollapseBlock
          id={id}
          actions={actions}
          data-test-id={args['data-test-id']}
          header={
            customHeader ? <CustomHeader {...args} /> : <MobileAccordionSecondary.CollapseBlockHeader {...args} />
          }
        >
          <Content />
        </MobileAccordionSecondary.CollapseBlock>
