...
const { GREY, PURPLE, GREEN, WHITE_ALFA, BLACK_ALFA, BLUE_GREY } = EXPORT_VARS;
...
export const GREEN_THEME = css`
  :global() {
    [data-theme='${Themes.Green}'] {
      ...
      ${COLORS.RADIO_SELECTED.LABEL}: var(${GREY[800]});
      ${COLORS.RADIO_SELECTED.ICON}: var(${BLUE_GREY[80]});

      ${COLORS.RADIO_SELECTED.HOVER.LABEL}: var(${GREY[800]});
      ${COLORS.RADIO_SELECTED.HOVER.ICON}: var(${GREEN[100]});
...
export const GREEN_DARK_THEME = css`
  :global() {
    [data-theme='${Themes.GreenDark}'] {
      ...
      ${COLORS.RADIO_SELECTED.LABEL}: var(${GREY[100]});
      ${COLORS.RADIO_SELECTED.ICON}: var(${GREEN[25]});
