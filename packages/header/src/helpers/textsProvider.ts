...
export enum Texts {
  ...
  FinancialMenuGetStarterGrant = 'financial-menu-get-starter-grant',
  FinancialMenuStarterGrantIsOnTheWay = 'financial-menu-starter-grant-is-on-the-way',
...
const dictionary: Partial<Record<LanguageCodeType, Record<Texts, string>>> = {
  [LanguageCodeType.ruRU]: {
    ...
    [Texts.FinancialMenuGetStarterGrant]: 'Получить стартовый грант',
    [Texts.FinancialMenuStarterGrantIsOnTheWay]: 'Стартовый грант уже в пути',
  ...
  [LanguageCodeType.enGB]: {
    ...
    [Texts.FinancialMenuGetStarterGrant]: 'Get a starter grant',
    [Texts.FinancialMenuStarterGrantIsOnTheWay]: 'Starter grant is on the way',
