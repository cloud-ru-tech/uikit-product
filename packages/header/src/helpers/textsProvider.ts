...
export enum Texts {
  ...
  FinancialMenuBonesesAction = 'financial-menu-boneses-action',
...
const dictionary: Partial<Record<LanguageCodeType, Record<Texts, string>>> = {
  [LanguageCodeType.ruRU]: {
    ...
    [Texts.FinancialMenuBonesesAction]: 'Ввести промокод',
  ...
  [LanguageCodeType.enGB]: {
    ...
    [Texts.FinancialMenuBonesesAction]: 'Enter promo code',
