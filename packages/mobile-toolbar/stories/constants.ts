...
export const BULK_ACTIONS = [
  {
    label: 'Confirm',
    icon: CheckSVG,
    onClick: () => mobileToaster.userAction.warning({ label: 'Confirm', 'data-test-id': TEST_ID_TOASTER.confirm }),
    'data-test-id': TEST_IDS.confirmAction,
  },
  {
    label: 'Remove confirmation',
    icon: CrossSVG,
    onClick: () => mobileToaster.userAction.warning({ label: 'Reject', 'data-test-id': TEST_ID_TOASTER.reject }),
    'data-test-id': TEST_IDS.rejectAction,
  },
  {
    label: 'Delete',
    icon: TrashSVG,
    onClick: () => mobileToaster.userAction.warning({ label: 'Delete', 'data-test-id': TEST_ID_TOASTER.delete }),
    disabled: true,
  ...
  },
  {
    ...
    icon: PlaceholderSVG,
    onClick: () =>
      mobileToaster.userAction.warning({ label: 'Deactivate', 'data-test-id': TEST_ID_TOASTER.deactivate }),
    'data-test-id': TEST_IDS.deactivateAction,
  },
  {
    label: 'Disabled Action',
    icon: PlaceholderSVG,
    onClick: () => mobileToaster.userAction.warning({ label: 'Disabled', 'data-test-id': TEST_ID_TOASTER.disabled }),
    disabled: true,
