...
export const COLORS = {
  ...
  MUTED_BORDER: '--color-datepicker-muted-border',
...
export const PURPLE_THEME = css`
  :global() {
    body[data-theme='${Themes.Purple}'] {
      ...
      ${COLORS.MUTED_BORDER}: var(${BLACK_ALFA[24]});
...
export const PURPLE_DARK_THEME = css`
  :global() {
    body[data-theme='${Themes.PurpleDark}'] {
      ${COLORS.BACKGROUND}: var(${GREY[750]});
      ...
      ${COLORS.SELECTED_RANGE_BACKGROUND}: var(${PURPLE_ALFA[24]})
    }
  }
`;
...
export const GREEN_DARK_THEME = css`
  :global() {
    body[data-theme='${Themes.GreenDark}'] {
      ...
      ${COLORS.DATE}: var(${GREY[100]});
      ${COLORS.DATE_BACKGROUND_HOVER}: var(${GREEN_ALFA[16]});
      ...
      ${COLORS.SELECTED_RANGE}: var(${GREY[0]});
      ${COLORS.SELECTED_RANGE_BACKGROUND}: var(${GREEN_ALFA[24]})
    }
  }
`;
