...
interface GroupHeadingProps<CustomOptionType>
  extends React.ComponentProps<typeof ReactSelectComponents.GroupHeading> {
  custom?: {
    open?: boolean;
...
export const CustomGroupHeading = <CustomOptionType,>(
  ...
  if (!collapsedGroup) {
    return (
      data: React.ComponentProps<typeof ReactSelectComponents.GroupHeading>,
    ): JSX.Element => <ReactSelectComponents.GroupHeading {...data} />;
  }
  ...
  return ({
    ...
    getStyles,
    ...props
  }: GroupHeadingProps<CustomOptionType>): JSX.Element => {
