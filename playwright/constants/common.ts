...
const { TEST_LOCAL, UIKIT_PRODUCT_URL, BRANCH_NAME, TEST_ON_BRANCH, PW_CI_WORKERS, CI } = process.env;

export const IS_CI = Boolean(CI);

export const IS_LOCAL = TEST_LOCAL === 'true' || !IS_CI;

export const UIKIT_URL = TEST_LOCAL === 'true' || !UIKIT_PRODUCT_URL ? 'https://localhost:6006/' : UIKIT_PRODUCT_URL;
