...
6. Получите аппрув
7. Смержите вашу ветку в мастер.
8. Релиз пакетов произойдет на этапе CI, вам не нужно поднимать руками версии
#### TODO: EXTEND GUIDE (HOW TO RELEASE FIRST STABLE)
